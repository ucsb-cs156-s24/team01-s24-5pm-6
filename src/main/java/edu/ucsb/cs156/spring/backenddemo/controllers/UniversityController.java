...
public class UniversityController {
    ...
    @Operation(summary = "Get list of universities with inputted name", description = "JSON return format documented here: http://universities.hipolabs.com/search?name={name}")
    @GetMapping("/get")
    public ResponseEntity<String> getUniversity(
        @Parameter(name="name", description="university name", example="Harvard") @RequestParam String name
